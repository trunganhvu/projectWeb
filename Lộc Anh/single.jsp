				...
				<div class="grid images_3_of_2">
						<ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="images/1.jpg" class="img-responsive" />
				  ...
				  <div class="desc1 span_3_of_2">
					...
					<h1>Adidas NMD R1</h1>
					 ...
					 <p>Adidas NMD,làn sóng mới của Adidas đã trở thành 1 trong những mẫu giày được săn đón nhất ở khắp nơi và Việt Nam cũng không ngoại lệ. Với thiết kế đơn giản và mang phong cách hiện đại và trẻ trung cùng với những cải tiến công nghệ của hãng càng làm đôi giày tăng giá trị. Với upper được làm từ sợi tổng hợp,đem lại cảm giác thoải mái cho người mang 1 cách tối ưu nhất . Bộ đế boost,niềm tự hào cùa Adidas cũng được đưa vào thiết kế này và càng nổi trội hơn với 2 miếng đệm EVA để tăng sự cố định cho đôi chân của bạn . Với nhiều phối màu đặc sắc ở Minhshop cùng giá rất tốt sẽ đem đến cho bạn sự hài lòng nhất có thể . </p>
